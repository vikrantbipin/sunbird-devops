                ...
                <div class="ui column height-fix">
                    <div class="max-container">
                        ...
                        <form id="kc-totp-login-form" class="${properties.kcFormClass!} ui form pre-signin" action="${url.loginAction}" method="post">
                            ...
                            <div class="field">
                                <button onclick="javascript:disableBtn(); javascript:makeDivUnclickable(); javascript:otpLoginUser()" class="ui fluid submit button" name="login" id="login" type="submit" value="${msg("doLogIn")}">${msg("doSubmit")}</button>
                            </div>

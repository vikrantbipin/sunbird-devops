                    ...
                    <div id="kc-locale" class="${properties.kcLocaleClass!}">
                        <div id="kc-locale-wrapper" class="${properties.kcLocaleWrapperClass!}">
                            <div class="kc-dropdown" id="kc-locale-dropdown">
                                ...
                                <select class="custom-select col-md-2" id="langSelect" onChange="javascript:gotoLang(event);">
                                    <#list locale.supported as l>
                                        <option value="${l.url}" name="${l.label}" class="kc-dropdown-item" id="langselectoption">${l.label}</option>
                                    </#list>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="ui column height-fix">
                        <div class="max-container">
                            ...
                            <div id="usePasswordDiv" class="mw-100" >
                                <form  onsubmit="login.disabled = true; return true;" class="ui form" method="POST" action="${url.loginAction}">
                                    ...
                                    <div id="selfSingUp" class="hide">
                                        ...
                                        <div class="field">
                                            ...
                                            <button type="button" class="sb-btn sb-btn-normal sb-btn-success width-100 mb-16" onclick="navigate('state')">
                                                ${msg("doSignWithState")}
                                            </button>
                            ...
                            <div id="useOTPDiv" class="mw-100" style="display:none">
                                <form class="${properties.kcFormClass!} ui form" onsubmit="login.disabled = true; return true;" action="${url.loginAction}" method="post">
